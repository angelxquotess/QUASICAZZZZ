...
class JarvisLive:
    ...
    async def _execute_tool(self, fc) -> types.FunctionResponse:
        ...
        if name not in ("jarvis_map", "home_screen", "save_memory"):
            try:
        ...
        try:
            if name == "open_app":
                ...
                # Return to initial JARVIS state: close the tactical map
                # window if it's open, then idle.
                from actions.jarvis_map import close_jarvis_map, is_jarvis_map_open
                was_open = is_jarvis_map_open()
                close_jarvis_map()
                result = "Returning to home screen, sir." if was_open else "Already on home screen, sir."
